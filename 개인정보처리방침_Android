...
1. 개인정보의 처리 목적
‘SeongHyeonKim’의 안드로이드 어플리케이션 "자하담"에서 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.
...
1. 이미지 마커에서 증강현실을 구현하여 화면에 보여주기 위해 카메라를 활용하여 android.permission.CAMERA를 사용합니다.
